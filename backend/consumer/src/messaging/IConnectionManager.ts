 ...
 *
 * Decouples the Consumer from the concrete broker implementation (RabbitMQ)
 * so the connection logic can be tested or swapped without modifying consumers.
 *
...
export interface IConnectionManager {
    /**
     * Establishes a connection to the message broker and sets up the
     * required exchanges, queues, and bindings.
     *
    ...
    /**
     * Gracefully closes the channel and connection to the broker.
    ...
    /**
     * Checks whether the manager currently holds an active connection and channel.
     *
